import { AuthClient, ChangeEmailResponse, ChangePasswordResponse, DeanonymizeResponse, ErrorPayload, JWTClaims, JWTHasuraClaims, NhostSessionResponse, ResetPasswordResponse, SecurityKey, SendVerificationEmailResponse, SignInResponse, SignOutResponse, SignUpResponse } from '@nhost/core';
import { AuthChangedFunction, ChangeEmailParams, ChangePasswordParams, DeanonymizeParams, NhostAuthConstructorParams, OnTokenChangedFunction, ResetPasswordParams, SendVerificationEmailParams, SignInParams, SignUpParams } from './utils/types';
/**
 * @alias Auth
 */
export declare class HasuraAuthClient {
     ...
     */
    getSession(): import("@nhost/core").NhostSession | null;
    /**
     *
     ...
     */
    getUser(): import("@nhost/core").User | null;
    /**
