...
export interface SignUpSecurityKeyState extends SignUpSecurityKeyHandlerResult, ActionLoadingState {
}
export declare const signUpEmailSecurityKeyPromise: (interpreter: import("xstate").Interpreter<import("..").AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
