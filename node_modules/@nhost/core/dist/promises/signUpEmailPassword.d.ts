...
import { ActionLoadingState, NeedsEmailVerificationState, SessionActionHandlerResult } from './types';
export interface SignUpEmailPasswordHandlerResult extends SessionActionHandlerResult, NeedsEmailVerificationState {
}
export interface SignUpEmailPasswordState extends SignUpEmailPasswordHandlerResult, ActionLoadingState {
}
export declare const signUpEmailPasswordPromise: (interpreter: import("xstate").Interpreter<import("..").AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
