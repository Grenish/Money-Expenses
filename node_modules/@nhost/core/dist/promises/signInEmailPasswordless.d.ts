...
export interface SignInEmailPasswordlessHandlerResult extends ActionErrorState, ActionSuccessState {
}
export interface SignInEmailPasswordlessState extends SignInEmailPasswordlessHandlerResult, ActionLoadingState {
}
export declare const signInEmailPasswordlessPromise: (interpreter: import("xstate").Interpreter<import("..").AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
