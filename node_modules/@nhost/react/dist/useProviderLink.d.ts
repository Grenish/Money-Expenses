import { Provider, ProviderOptions } from '@nhost/core';
/**
 ...
 * ```
 */
export declare const useProviderLink: (options?: ProviderOptions) => Record<Provider, string>;
//# sourceMappingURL=useProviderLink.d.ts.map